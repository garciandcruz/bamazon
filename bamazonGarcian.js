                ...
                if (res.length === 0) {
                    ...
                    if (quantity <= productInfo.stock_quantity) {
                        ...
                        connection.query(updateQueryStr, function (err, data) {
                            ...
                            console.log("Thank you for shopping with bamazonGarcian!")
                            console.log(" - - - - - - - - - - - - - - - ")
                            console.log("To shop again with us please input 'node bamazonGarcian.js' into your command line again.")
                            console.log("\n")
